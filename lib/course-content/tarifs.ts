...
export const modules: CourseModuleData[] = [
  {
    ...
    "lessons": [
      ...
      {
        "id": "ta1l2",
        "title": "Prix, valeur perçue et positionnement",
        "html": "\n      <p>Le prix qu'un client accepte de payer ne dépend pas uniquement du coût réel de ta prestation : il dépend surtout de la valeur qu'il perçoit. Comprendre ce mécanisme change complètement la façon d'aborder ses tarifs.</p>\n      <h4>La valeur perçue n'est pas la valeur réelle</h4>\n      <p>Deux prestations strictement identiques en contenu peuvent être vendues à des prix très différents selon la façon dont elles sont présentées, le positionnement du prestataire, et le contexte dans lequel elles sont proposées. Un client ne compare pas des heures de travail : il compare des résultats, des risques évités, et un niveau de confiance.</p>\n      <h4>Ce qui construit la valeur perçue</h4>\n      <ul>\n        <li><strong>L'expertise démontrée</strong> : portfolio, références, façon de s'exprimer sur le sujet.</li>\n        <li><strong>La clarté du processus</strong> : un client qui comprend précisément ce qu'il obtient et comment perçoit moins de risque, donc plus de valeur.</li>\n        <li><strong>Le positionnement</strong> : se positionner comme spécialiste d'un secteur ou d'un type de projet augmente la valeur perçue, comparé à un positionnement généraliste.</li>\n        <li><strong>La rareté et la sélectivité</strong> : un professionnel qui n'accepte pas toutes les missions, ou qui a un délai d'attente, envoie un signal de valeur, même involontairement.</li>\n      </ul>\n      <h4>Le piège du positionnement \"pas cher\"</h4>\n      <p>Se positionner explicitly comme l'option la moins chère du marché attire une clientèle qui restera sensible avant tout au prix — et qui partira dès qu'un concurrent proposera moins cher. Ce positionnement, en plus d'être économiquement fragile, est aussi le plus difficile à faire évoluer par la suite.</p>\n      <h4>Choisir consciemment son positionnement</h4>\n      <p>Un positionnement clair et assumé (spécialiste, expert reconnu, valeur premium, accompagnement complet...) permet de construire une tarification cohérente, plutôt que de fixer un prix au hasard puis de le justifier après coup.</p>\n      <div class=\"callout\"><strong>Un exercice utile :</strong> demande-toi ce que ton client gagne réellement à travailler avec toi — du temps, de la tranquillité d'esprit, un risque évité, un résultat professionnel — plutôt que de penser uniquement en heures de travail fournies.</div>\n      ",
        "keypoints": [
          "La valeur perçue par le client détermine le prix acceptable, bien plus que le coût réel de la prestation.",
          "L'expertise démontrée, la clarté du processus et le positionnement construisent la valeur perçue.",
  ...
  },
  {
    ...
    "lessons": [
      ...
      {
        "id": "ta2l3",
        "title": "Créer différentes offres (entrée de gamme / premium)",
        "html": "\n      <p>Proposer plusieurs niveaux d'offre, plutôt qu'un tarif unique, élargit ta clientèle potentielle et facilite souvent la décision d'achat — sans jamais brader ton offre principale.</p>\n      <h4>Pourquoi proposer plusieurs niveaux</h4>\n      <p>Un client hésitant face à un tarif unique n'a que deux choix : accepter ou refuser. Face à plusieurs offres, il compare et choisit celle qui correspond le mieux à son budget et à son besoin — ce qui augmente les chances de conclure une vente, même si ce n'est pas toujours au niveau le plus élevé.</p>\n      <h4>Structurer 2 à 3 niveaux d'offre</h4>\n      <ul>\n        <li><strong>Offre essentielle :</strong> le cœur de ta prestation, sans options superflues — pour les budgets plus serrés ou les besoins simples.</li>\n        <li><strong>Offre standard :</strong> ton offre de référence, celle que tu recommandes naturellement à la majorité des clients.</li>\n        <li><strong>Offre premium :</strong> une version enrichie (délai accéléré, accompagnement renforcé, options supplémentaires), pour les clients prêts à investir davantage pour plus de confort ou de résultat.</li>\n      </ul>\n      <h4>Le rôle stratégique de l'offre premium</h4>\n      <p>Même si peu de clients choisissent l'offre premium, sa seule présence rend l'offre standard plus attractive par comparaison — un effet d'ancrage bien documenté en psychologie de la décision. L'offre premium justifie aussi, en creux, la valeur de l'offre standard.</p>\n      <h4>Ce qu'il ne faut jamais faire</h4>\n      <p>Ne construis jamais ton offre \"entrée de gamme\" en bradant ton tarif horaire réel : elle doit rester rentable, simplement avec un périmètre plus restreint (moins d'options, moins de révisions, délai plus long) — jamais avec le même travail à prix cassé.</p>\n      <div class=\"callout\"><strong>Une bonne pratique :</strong> nomme chaque offre de façon parlante pour le client (plutôt que \"Offre 1 / 2 / 3\"), en lien avec le résultat ou le contexte d'usage — cela aide le client à se projeter et facilite sa décision.</div>\n      ",
        "keypoints": [
          "Proposer plusieurs niveaux d'offre facilite la décision d'achat, comparé à un tarif unique.",
          "Structure généralement 2 à 3 niveaux : essentiel, standard, premium.",
          "L'offre premium rend l'offre standard plus attractive par effet de comparaison, même si peu de clients la choisissent.",
          "L'offre d'entrée de gamme doit rester rentable : un périmètre réduit, jamais un même travail bradé."
        ]
      }
    ],
    "quiz": [
